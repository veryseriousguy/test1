...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__new_post_new_post_component__ = __webpack_require__("./src/app/new-post/new-post.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var rootRouterConfig = [
    ...
    { path: 'new-post', component: __WEBPACK_IMPORTED_MODULE_7__new_post_new_post_component__["a" /* NewPostComponent */] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__new_post_new_post_component__["a" /* NewPostComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot(rootRouterConfig), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormsModule */]
            ],
            providers: [],
...
module.exports = "<h1>All Posts</h1>\n<button class=\"btn btn-success\" (click)=\"AddNewPost()\">Add Post</button>\n<div *ngFor=\"let post of posts\" class=\"printedPosts\">\n  <h3>{{ post.title }}</h3>\n  <p>{{ post.body }}</p>\n  <div>{{ post.author }}</div>\n</div>\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.AddNewPost = function () {
